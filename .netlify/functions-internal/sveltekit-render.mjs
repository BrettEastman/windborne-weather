		...
		routes: [
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/balloons/_server.ts.js'))
			},
			{
				id: "/api/satellites",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/satellites/_server.ts.js'))
			}
		],
